 ...
 */
public class VideoDownloaderFrameOld extends JFrame {
     ...
     */
    public VideoDownloaderFrameOld() {
    ...
    private void downloadVideo() {
        ...
        if (url.isEmpty()) {
            SwingUtilities.invokeLater(() -> JOptionPane.showMessageDialog(VideoDownloaderFrameOld.this,
